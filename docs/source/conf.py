...
latex_documents = [
    (master_doc, 'compress_pickle.tex', 'compress\\_pickle Documentation',
     'Luciano Paz', 'manual'),
]
...
man_pages = [
    (master_doc, 'compress_pickle', 'compress_pickle Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'compress_pickle', 'compress_pickle Documentation',
     author, 'compress_pickle', 'One line description of project.',
     'Miscellaneous'),
]
